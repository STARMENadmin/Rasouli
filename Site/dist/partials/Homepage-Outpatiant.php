			<div class="left" data-parallax='{"y" : 100, "smoothness": 10}'>
			...
			<div class="right">
				...
				<div class="parallaxwrapper">
					...
					<img  class="paraImage2 desktop" id="homeOutPatientIMG" src="img/outpatient-2.jpg" data-parallax='{"y" : 100, "smoothness": 10}'/>
				</div>
