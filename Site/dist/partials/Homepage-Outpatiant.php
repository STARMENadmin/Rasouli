			<div class="left parallax" data-parallax='{"y" : 100, "smoothness": 0}'>
				...
				<a class="textCTA black" href="#">Learn More<span class="linkArrow linkArrowBlack"></span></a>
				
			</div>
			<div class="right">
				
				<div class="parallaxwrapper">
					<img class="paraImage1 parallax" src="img/outpatient-1.jpg" data-parallax='{"y" : -50, "smoothness": 0}'/>
					<img  class="paraImage2 desktop parallax" id="homeOutPatientIMG" src="img/outpatient-2.jpg" data-parallax='{"y" : 60, "smoothness": 0}'/>
				</div>
